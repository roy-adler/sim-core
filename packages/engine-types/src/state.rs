...
impl Agent {
    ...
    ///
    /// TODO(haze): This should utilize some macro to auto generate `BUILTIN_FIELDS`, instead of
    ...
    /// JSON values. (TODO(haze): investigate / is this even possible?)
